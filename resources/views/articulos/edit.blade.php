                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <select name="categoria_id" id="categoria_id" class="form-control">
                                        <option value="{{$articulo->categoria->id}}" selected>{{$articulo->categoria->nombre}}</option>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <select name="fabricante_id" id="fabricante_id" class="form-control">
                                        <option value="{{$articulo->fabricante->id}}" selected>{{$articulo->fabricante->nombre}}</option>
