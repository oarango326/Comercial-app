            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="form-inline">
                        <a href="{{route('articulos.show',$articulo->id )}}" class="btn btn-primary btn-sm m-1 align-content-end">Ver</a>
                        <form action="{{route('articulos.update', $articulo->id )}}" method="post">
                                {!!method_field('PUT')!!}
                                {!! csrf_field() !!}
                                @if($articulo->activo=='1')
                                    <input type="hidden" name="activar" value="0">
                                    <button type="submit" class="btn btn-info btn-sm m-1 align-content-end">Desactivar</button>
                                @else
                                    <input type="hidden" name="activar" value="1">
                                    <button type="submit" class="btn btn-success btn-sm m-1 align-content-end">Activar</button>
                                @endif
                        </form>
                    ...
                    {{-- <div class="card" style="width: 18rem; margin:5px">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="{{route('articulos.show',$articulo->id )}}" class="btn btn-primary align-content-end">Ver</a>
                                </div>
                            </div>
                        </div>
                    </div> --}}
