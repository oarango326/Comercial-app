    ...
    <form action="{{route('facturas.update',$factura->id)}}" method="POST" >
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3  col-xl-3">
                ...
                <select name="cliente_id" id="selectcliente" class="form-control "  required>
                    ...
                    <option value="{{$cli->id}}" direccion="{{$cli->direccion}} {{$cli->ciudad}} {{$cli->estado}} {{$cli->telefono}}">{{$cli->nombre}}</option>
                    @endforeach
                </select>
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 col-xl-6">
                ...
                <input type="text"  id="direccion" class="form-control" value="{{$cliente[0]->direccion}} {{$cliente[0]->ciudad}} {{$cliente[0]->estado}} {{$cliente[0]->telefono}}" readonly>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 ">
                <label for="lblfabricante">Fecha Documento</label>
            <input type="date" name="facfecha" id="facfecha" class="form-control" value="{{$factura->facfecha}}" required>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-4 col-lg-4 col-xl-2">
                ...
                <option selected value="{{$factura->tipodoc}}">{{($factura->tipodoc==0)?'FACTURA':'ALBARAN'}}</option>
            ...
            <input type="text" name="facnum" id="facnum" class="form-control" maxlength="10" value="{{$factura->facnum}}" required>
            </div>

            <div class="col-xs-12 col-md-4 col-lg-2 ">
                <label for="lblmonto">Monto Nota</label>
            <input  style="text-align: right;" type="text"  name="total" id="total" class="form-control montos" value="{{$factura->total}}" required>
             </div>
             {{-- <div class="col-xs-12 col-md-4 col-lg-2 ">
