...
<div class="container">
    <div class="row">
        <div class="col-xs-6 col-md-3 col-sm-3 col-lg-3 justify-content-start">
            <h3>Fabricantes</h3>
        </div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {{-- <a class="btn btn-primary btn-sm m-1" href="{{route('fabricantes.show',$fabricante->id)}}"
                        role="button">Ver</a> --}}
                        <a class="btn btn-primary btn-sm m-1" href="{{route('fabricantes.edit',$fabricante->id)}}"
                            role="button">Modificar</a>
                        <button type="button" class="btn btn-danger btn-sm m-1 btnDelete" data-toggle="modal"
                            data-target="#modalDelete" data-id="{{$fabricante->id}}"
