<!--Modal Client Create-->
<div class="modal fade" id="modalcreateclient" tabindex="-1" role="dialog" aria-labelledby="modalclientlabel" aria-hidden="true">
            ...
            <div >
                <div class="row">
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                        ...
                        <input type="text" class="form-control" name="Nombre" value="{{old('Nombre')}}" required="true">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-2 col-sm-4 col-md-4">
                        ...
                        <input type="text" class="form-control" maxlength="5" size="5" name="CodigoPostal" required="true">
                    </div>
                </div>
                <div class="row">
...
<!-- modal Client show -->
<div class="modal fade" id="modalshowclient" tabindex="-1" role="dialog" aria-labelledby="modalclientlabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
        ...
        <div >
            ...
            <div class="row">
                ...
                <div class="col-xs-2 col-sm-4 col-md-4">
                    <label for="lblcp" class="col-form-label">Codigo Postal</label>
                    <input type="text" class="form-control" maxlength="5" size="5" name="codigoPostal" id="modalTxtCodigoPostal" disabled>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6">
...
<!--fin Modal Client-->
<!-- Modal Client Delete-->
<div class="modal fade" id="modalDeleteClient" tabindex="-1" role="dialog" aria-labelledby="modalDeleteClient" aria-hidden="true">
