...
@section('contenido')
    <div class="row" >
        ...
        <div class="col-xs-12 col-sm-3 col-lg-3 justify-content-start" >
                <a class="btn btn-primary m-1"  href="#" data-toggle="modal" data-target="#modalcreateclient" role="button" id="modalCreateClient">Nuevo Cliente</a>
                    ...
                    <tbody>
                        @foreach ($clientes as $cliente)
                            <tr>
                                ...
                                <td class="d-xs-none">
                                    <a class="btnshowclient" href="#" data-toggle="modal" data-target="#modalshowclient" data-href="{{ url("/cliente/$cliente->id")}}" data-action="0" role="button">{{ $cliente->nombre }}</a>
                                </td>
                                <td class="d-xs-none">
                                    {{ $cliente->cif }}
                                </td>
