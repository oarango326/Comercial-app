...
<div class="row" >
    ...
    <a class="btn btn-primary m-1"  href="{{route('cobros.create')}}" role="button"
            id="btnCreatecobro">Nuevo Cobro</a>
    </div>
                    ...
                    {{-- <div class="card" style="width: 18rem; margin:5px">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    <a href="{{route('cobros.show',$cobro->id )}}" class="btn btn-primary align-content-end">Ver</a>
                                </div>
                            </div>
                        </div>
                    </div> --}}
